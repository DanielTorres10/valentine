import{r as a,u as b,l as m,V as h,h as g,a as w,j as r}from"./three-DoDmUXEH.js";import{u as y,C as z}from"./index-DTAMNN3q.js";const j=`
...
`,S=({textureMapper:s,nParticles:t=512,usePoints:c=!0,interpolate:i=!1,color:u=new w("green")})=>{const{tex:n,textureData:p}=s.generateSupportedTextureAndData();n.needsUpdate=!0;const e=a.useRef(null),l=b(o=>o.size),d=a.useMemo(()=>new Float32Array(t).fill(0).map((o,v)=>v),[t]),f=a.useMemo(()=>new Float32Array(t*3).fill(0),[t]),x=a.useMemo(()=>({color:{value:new h},max_amplitude:{value:s.maxAmplitude},sample_scale:{value:new m(t,1)},samples:{type:"t",value:n},resolution:{value:new m(l.width,l.height)},b_should_interpolate:{value:i}}),[t,s,i,l,n]);g(()=>{s.updateTextureData(p),n.needsUpdate=!0,e.current&&(e.current.uniforms.max_amplitude.value=s.maxAmplitude,e.current.uniforms.samples.value=n)}),a.useEffect(()=>{var o;(o=e.current)!=null&&o.uniforms&&(e.current.uniforms.resolution.value.x=l.width,e.current.uniforms.resolution.value.y=l.height)},[l]),a.useEffect(()=>{var o;(o=e.current)!=null&&o.uniforms&&(e.current.uniforms.b_should_interpolate.value=i,e.current.uniforms.color.value.x=u.r,e.current.uniforms.color.value.y=u.g,e.current.uniforms.color.value.z=u.b)},[i,u]),a.useEffect(()=>{var o;(o=e.current)!=null&&o.uniforms&&(e.current.uniforms.sample_scale.value.x=t,e.current.uniforms.sample_scale.value.y=1)},[t]);const _=r.jsxs(a.Fragment,{children:[r.jsxs("bufferGeometry",{children:[r.jsx("bufferAttribute",{attach:"attributes-position",count:t,array:f,itemSize:3}),r.jsx("bufferAttribute",{attach:"attributes-index",count:t,array:d,itemSize:1})]}),r.jsx("shaderMaterial",{ref:e,depthWrite:!1,fragmentShader:j,vertexShader:D,uniforms:x})]});return c?r.jsx("points",{children:_}):r.jsx("line",{children:_})},E=({textureMapper:s})=>{const t=y(),c=z.getPalette(t).lerpColor(.5);return r.jsx(S,{textureMapper:s,usePoints:!0,interpolate:!1,color:c})};export{E as default};
